...
function mycttee(){
      const cte='<table id="tbl"><tr><td>Chair:</td><td>Lynva Chamberlain<tr><td>Directors</td><td>Allan Evans/Colin Nunn</td></tr><tr><td>Treasurer:</td><td>Jane Frampton</td></tr><td>Secretary:</td><td>Marian East</td></tr><tr><td>Scorer:</td><td>Andy Dick</td></tr><tr><td>Partnership Coordinator:</td><td>Dorothy Williams</td></tr></table><br>';
      const div=document.createElement("div");
      const mydiv=document.getElementById("mainsect");
      mydiv.appendChild(div);
      div.innerHTML=cte;
...
function myfees(){
   const fees='<p class="mytxt">The Fees are paid annually in April. They fees for the year to April 2026 are set at £40. There is no Table charge for members, however, visitors pay £4 for each session.</p>';
      const div=document.createElement("div");
      const mydiv=document.getElementById("mainsect");
      mydiv.appendChild(div);
      div.innerHTML=fees;
