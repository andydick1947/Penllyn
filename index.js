...
function myfees(){
   const fees='<p class="mytxt">The Fees are paid annually in April. They fees for the year to April 2027 are set at £40. There is no Table charge for members, however, visitors pay £4 for each session.</p>';
      const div=document.createElement("div");
      const mydiv=document.getElementById("mainsect");
      mydiv.appendChild(div);
      div.innerHTML=fees;
